...
export const Home = () => {
  ...
  const handleParticipantAdd = () => {
    ...
    setParticipants((prevState) => [...prevState, participantName]) // pra não substituir agente ja pega tudo oq tem dentro e add um novo
    setParticipantName('');
  }

  const handleParticipantRemove = (name:string) => {
    Alert.alert("Remover", `Remover o participante nome ${name}?`, [
      {
        text: 'Sim',
